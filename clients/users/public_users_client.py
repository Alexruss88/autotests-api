...
# from clients.api_client import APIClient
# from clients.public_http_builder import get_public_http_client
# from .public_users_schema import CreateUserRequestSchema, CreateUserResponseSchema
...
from clients.api_client import APIClient
from clients.public_http_builder import get_public_http_client
from .users_schema import CreateUserRequestSchema, CreateUserResponseSchema
...
class PublicUsersClient(APIClient):
    ...
    def create_user(self, request: CreateUserRequestSchema) -> CreateUserResponseSchema:
        """Метод создает пользователя и возвращает строго типизированный ответ."""
        response = self.create_user_api(request)
